    ...
    <div className="min-h-screen bg-white flex flex-col font-sans selection:bg-purple-200">
      ...
      <main className="flex-1">
        ...
        <div className="pt-20 pb-16 px-6 max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4 text-sm font-medium text-slate-500">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-purple-600 to-blue-500 flex items-center justify-center text-white font-black text-xl shadow-md">
                P
              </div>
              <div className="text-left">
                <p className="text-slate-900 font-black text-base">PdfNexa Team</p>
        ...
        <article className="max-w-3xl mx-auto px-6 py-16">
          {/* 🔥 MAGIC CSS HERE 🔥: 
            1. 'whitespace-pre-wrap' ensures your enter keys (paragraphs) show up correctly.
            2. [&>h2] styles make sure if you use HTML headings, they look huge and professional. 
          */}
          <div 
