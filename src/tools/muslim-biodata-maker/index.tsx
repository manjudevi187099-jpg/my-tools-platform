...
interface BiodataData {
  ...
  personal: {
    ...
    complexion: string;
    religion: string;
    sect: string; // Sunni/Shia
    caste: string; // Sheikh, Syed, Pathan, etc.
...
const BORDER_OPTIONS = [
  { id: '', name: '🚫 No Border' },
  { id: 'border-[12px] border-emerald-800', name: '🟩 Thick Green' },
  { id: 'border-[16px] border-double border-[#064e3b]', name: '🏛️ Classic Double' },
  { id: 'border-[12px] border-double border-[#d4af37]', name: '👑 Royal Gold' },
  { id: 'border-8 border-emerald-500', name: '🟩 Solid Emerald' },
  { id: 'border-[16px] border-[#064e3b] outline outline-4 outline-offset-[-20px] outline-[#d4af37]', name: '✨ Premium Inset' },
  { id: 'border-[12px] border-[#1e3c45]', name: '🟦 Thick Teal' },
  { id: 'border-8 border-dashed border-emerald-600', name: '✂️ Dashed Floral' },
];

export default function MuslimBiodataMaker() {
  ...
  const [data, setData] = useState<BiodataData>({
    template: 't1',
    border: 'border-[12px] border-emerald-800',
    photo: null,
    personal: {
      name: 'Mohammad Tariq',
      dob: '15 August 1995',
      tob: '10:30 AM',
      pob: 'Lucknow, Uttar Pradesh',
      height: '5 ft 10 in',
      complexion: 'Fair',
      religion: 'Islam',
      sect: 'Sunni',
  ...
  // --- 🌟 10 AUTHENTIC ISLAMIC MATRIMONIAL TEMPLATES 🌟 ---
  const renderTemplate = () => {
    ...
    switch(template) {
      case 't1': // Classic Green/Red
        return (
          <div className={`w-[794px] h-[1123px] bg-[#fffdf5] text-[#064e3b] font-serif shadow-2xl p-10 box-border flex flex-col ${border}`}>
            <div className="text-center mb-6">
              <h2 className="text-3xl font-bold mt-2 tracking-widest text-[#064e3b]">﷽</h2>
              <p className="text-sm font-bold tracking-widest">786</p>
            </div>
            
            <div className="flex justify-between items-start px-4 mb-6">
              <div className="flex-1 mt-4">
                <h3 className="text-2xl font-black uppercase tracking-widest border-b-2 border-[#064e3b] inline-block pb-1 mb-6">Personal Details</h3>
                ...
                <Row label="Maslak/Sect" value={personal.sect} />
                <Row label="Caste" value={personal.caste} />
                <Row label="Marital Status" value={personal.maritalStatus} />
              </div>
              <div className="w-40 h-48 border-4 border-[#064e3b] p-1 bg-white ml-8 shadow-md">
                {photo ? <img src={photo} className="w-full h-full object-cover" /> : <div className="w-full h-full bg-emerald-50 flex items-center justify-center font-bold text-emerald-200">PHOTO</div>}
              </div>
            </div>

            <div className="px-4 mb-6">
              <h3 className="text-2xl font-black uppercase tracking-widest border-b-2 border-[#064e3b] inline-block pb-1 mb-4">Education & Career</h3>
            ...
            <div className="px-4 mb-6">
              <h3 className="text-2xl font-black uppercase tracking-widest border-b-2 border-[#064e3b] inline-block pb-1 mb-4">Family Details</h3>
            ...
            <div className="px-4">
              <h3 className="text-2xl font-black uppercase tracking-widest border-b-2 border-[#064e3b] inline-block pb-1 mb-4">Contact Details</h3>
      ...
      case 't2': // Split Emerald & White
        return (
          <div className={`w-[794px] h-[1123px] bg-white flex shadow-2xl overflow-hidden font-sans box-border ${border}`}>
            <div className="w-[35%] bg-[#047857] text-white p-8 flex flex-col items-center">
              <div className="w-36 h-40 border-4 border-white shadow-xl mb-6 bg-white overflow-hidden">
                {photo ? <img src={photo} className="w-full h-full object-cover" /> : <div className="w-full h-full bg-emerald-200"></div>}
              </div>
            ...
            <div className="w-[65%] p-10 bg-white relative">
              <div className="text-center mb-6 relative">
                ...
                <h1 className="text-4xl font-black text-[#047857] relative z-10 pt-4">BIO DATA</h1>
                <h2 className="text-2xl font-bold text-slate-800 mt-2 relative z-10">{personal.name}</h2>
              </div>

              <div className="mb-6">
                <h3 className="text-lg font-black text-emerald-900 uppercase mb-4 text-center border-b border-emerald-900 pb-1">Personal Information</h3>
                <Row label="Date of Birth" value={personal.dob} />
                <Row label="Time of Birth" value={personal.tob} />
                <Row label="Place of Birth" value={personal.pob} />
                <Row label="Religion" value={personal.religion} />
                <Row label="Sect/Maslak" value={personal.sect} />
                <Row label="Caste" value={personal.caste} />
                <Row label="Marital Status" value={personal.maritalStatus} />
              </div>

              <div className="mb-6">
                <h3 className="text-lg font-black text-emerald-900 uppercase mb-4 text-center border-b border-emerald-900 pb-1">Family Details</h3>
              ...
              <div>
                <h3 className="text-lg font-black text-emerald-900 uppercase mb-4 text-center border-b border-emerald-900 pb-1">Contact Details</h3>
                <Row label="Contact No." value={contact.phone} />
                <Row label="Address" value={contact.address} />
              </div>
            </div>
      ...
      case 't3': // Dark Maroon & Gold Royal
        return (
          <div className={`w-[794px] h-[1123px] bg-[#4a0e17] text-[#f4d068] font-serif shadow-2xl p-12 box-border flex flex-col relative ${border}`}>
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold tracking-widest mb-1">﷽</h2>
            ...
            <div className="flex justify-between items-start mb-8">
              <div className="flex-1 pr-6 space-y-2">
                ...
                <Row label="Sect & Caste" value={`${personal.sect} / ${personal.caste}`} colorClass="text-[#f4d068]" />
                <Row label="Marital Status" value={personal.maritalStatus} colorClass="text-[#f4d068]" />
              </div>
      ...
      case 't4': // The Arch Mosque/Crescent Design
        return (
          <div className={`w-[794px] h-[1123px] bg-[#064e3b] text-black font-sans shadow-2xl flex flex-col items-center pt-16 box-border ${border}`}>
            ...
            <div className="w-[90%] h-[95%] bg-white rounded-t-[100px] shadow-2xl p-10 flex flex-col relative">
              ...
              <div className="text-center mt-6 mb-8">
                <h2 className="text-[#064e3b] font-black text-xl mb-1">786</h2>
                <h3 className="text-[#064e3b] font-bold text-2xl mb-2">﷽</h3>
                <h4 className="text-gray-500 font-bold tracking-widest mt-2">BIO DATA</h4>
                <h1 className="text-4xl font-black text-[#064e3b] uppercase mt-2">{personal.name}</h1>
              </div>

              <div className="absolute top-16 right-10 w-32 h-32 rounded-full border-4 border-[#064e3b] overflow-hidden shadow-lg p-1 bg-white">
              ...
              <div className="space-y-3 px-6 mt-4">
                ...
                <Row label="Religion" value={personal.religion} />
                <Row label="Caste" value={personal.caste} />
                <Row label="Sect" value={personal.sect} />
                <Row label="Height" value={personal.height} />
                <Row label="Complexion" value={personal.complexion} />
                <Row label="Education" value={education.degree} />
                <Row label="Occupation" value={education.profession} />
              ...
              <div className="px-6 mt-8">
                <h3 className="text-2xl font-black text-[#064e3b] mb-4">Family Details</h3>
              ...
              <div className="px-6 mt-8">
                <h3 className="text-2xl font-black text-[#064e3b] mb-4">Contact Details</h3>
                <div className="space-y-3">
        ...
        return (
          <div className={`w-[794px] h-[1123px] bg-[#750e38] text-white font-serif shadow-2xl p-10 box-border flex flex-col border-[8px] border-[#d4af37] ${border}`}>
            <div className="border-4 border-[#d4af37] p-8 flex-1 relative">
               <h1 className="text-center text-3xl mb-4 text-[#d4af37]">﷽</h1>
               ...
               <div className="flex justify-between items-start mb-8">
                 <div className="flex-1 space-y-3 pr-4">
                   ...
                   <Row label="Sect/Caste" value={`${personal.sect}, ${personal.caste}`} colorClass="text-[#f8e1a8]" />
                   <Row label="Height" value={personal.height} colorClass="text-[#f8e1a8]" />
                   <Row label="Marital Status" value={personal.maritalStatus} colorClass="text-[#f8e1a8]" />
                 </div>
            ...
            <div className="w-[65%] p-10 flex flex-col justify-center space-y-10">
               <div>
                 ...
                 <div className="space-y-3">
                    ...
                    <Row label="Caste" value={personal.caste} />
                    <Row label="Sect" value={personal.sect} />
                    <Row label="Status" value={personal.maritalStatus} />
                 </div>
               </div>
               <div>
        ...
        return (
          <div className={`w-[794px] h-[1123px] bg-[#fdfdfd] text-slate-900 font-serif shadow-2xl p-12 box-border flex flex-col ${border}`}>
             <div className="text-center border-b-2 border-slate-300 pb-6 mb-8">
                <h2 className="text-3xl text-[#064e3b] font-bold mb-2">﷽</h2>
                <h1 className="text-5xl font-black uppercase tracking-widest text-slate-800 mt-4">{personal.name}</h1>
             </div>
      ...
      case 't8': // Royal Green & Gold
        return (
          <div className={`w-[794px] h-[1123px] bg-[#0d2b1d] text-[#e8d38e] font-serif shadow-2xl p-10 box-border flex flex-col border-[12px] border-double border-[#e8d38e] ${border}`}>
             <div className="text-center mb-6">
                <span className="text-4xl text-[#e8d38e]">﷽</span>
             </div>
               ...
               <div className="w-2/3 space-y-8 pr-4">
                  <div>
                    ...
                    <div className="space-y-3 pl-2">
                       ...
                       <Row label="Sect" value={personal.sect} colorClass="text-[#e8d38e]" />
                       <Row label="Status" value={personal.maritalStatus} colorClass="text-[#e8d38e]" />
                    </div>
                  </div>
          ...
          <div className={`w-[794px] h-[1123px] bg-white text-[#5c1c38] font-sans shadow-2xl p-0 box-border flex flex-col ${border}`}>
             <div className="bg-[#a8325a] text-white p-10 flex items-center justify-between">
                <div>
                  ...
                  <h2 className="text-lg font-bold opacity-80 uppercase tracking-widest">Biodata Profile</h2>
                </div>
             ...
             <div className="p-12 space-y-10 flex-1 bg-[#fff5f8]">
                <section>
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      <div><span className="font-bold">Born:</span> {personal.dob}</div>
                      ...
                      <div><span className="font-bold">Caste:</span> {personal.religion}, {personal.caste}</div>
                      <div><span className="font-bold">Sect:</span> {personal.sect}</div>
                   </div>
                </section>
               ...
               <div className="w-[70%] space-y-8">
                  <div>
                    ...
                    <div className="space-y-3">
                       ...
                       <Row label="Caste/Sect" value={`${personal.caste}, ${personal.sect}`} colorClass="text-[#4a3f35]" />
                       <Row label="Status" value={personal.maritalStatus} colorClass="text-[#4a3f35]" />
                    </div>
                  </div>
      ...
      case 0:
        return (
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-black text-slate-800 mb-6">1. Choose Islamic Template</h3>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {[
                  {id:'t1', name:'🕌 Classic Green'}, {id:'t2', name:'🟩 Split Emerald'}, {id:'t3', name:'👑 Royal Maroon'}, 
                  {id:'t4', name:'🌙 Mosque Arch'}, {id:'t5', name:'🌸 Deep Magenta'}, {id:'t6', name:'🟦 Modern Navy'}, 
                  ...
                  <button 
                    ...
                    className={`p-3 rounded-xl border-2 font-black text-[11px] uppercase tracking-wider transition-all ${data.template === t.id ? 'border-emerald-600 bg-emerald-50 text-emerald-800 shadow-md' : 'border-slate-200 text-slate-500 hover:border-emerald-300'}`}
                  >
                    {t.name}
                  </button>
                ))}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {BORDER_OPTIONS.map(b => (
                  <button 
                    ...
                    className={`p-3 rounded-xl border-2 font-black text-[11px] tracking-wider transition-all ${data.border === b.id ? 'border-emerald-600 bg-emerald-50 text-emerald-800 shadow-md' : 'border-slate-200 text-slate-600 hover:border-emerald-300'}`}
                  >
                    {b.name}
                  </button>
                ))}
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
            ...
            <div>
              ...
              <input type="text" value={data.personal.name} onChange={e => handlePersonal('name', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 focus:border-emerald-500 outline-none" />
            </div>
            <div className="border-4 border-dashed border-slate-200 rounded-2xl p-6 flex flex-col items-center justify-center relative hover:border-emerald-400 bg-slate-50 transition-colors">
      ...
      case 2:
        return (
          <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2 md:col-span-1"><label className="text-xs font-bold text-slate-500 uppercase">Date of Birth</label><input type="text" value={data.personal.dob} onChange={e => handlePersonal('dob', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2 md:col-span-1"><label className="text-xs font-bold text-slate-500 uppercase">Time of Birth</label><input type="text" value={data.personal.tob} onChange={e => handlePersonal('tob', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2"><label className="text-xs font-bold text-slate-500 uppercase">Place of Birth</label><input type="text" value={data.personal.pob} onChange={e => handlePersonal('pob', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2 md:col-span-1"><label className="text-xs font-bold text-slate-500 uppercase">Height</label><input type="text" value={data.personal.height} onChange={e => handlePersonal('height', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2 md:col-span-1"><label className="text-xs font-bold text-slate-500 uppercase">Complexion</label><input type="text" value={data.personal.complexion} onChange={e => handlePersonal('complexion', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2 md:col-span-1"><label className="text-xs font-bold text-slate-500 uppercase">Religion</label><input type="text" value={data.personal.religion} onChange={e => handlePersonal('religion', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2 md:col-span-1"><label className="text-xs font-bold text-slate-500 uppercase">Sect / Maslak</label><input type="text" value={data.personal.sect} onChange={e => handlePersonal('sect', e.target.value)} placeholder="Sunni / Shia etc." className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2 md:col-span-1"><label className="text-xs font-bold text-slate-500 uppercase">Caste / Surname</label><input type="text" value={data.personal.caste} onChange={e => handlePersonal('caste', e.target.value)} placeholder="Sheikh, Syed, Pathan etc." className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2 md:col-span-1"><label className="text-xs font-bold text-slate-500 uppercase">Marital Status</label><input type="text" value={data.personal.maritalStatus} onChange={e => handlePersonal('maritalStatus', e.target.value)} placeholder="Never Married / Divorced" className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
            </div>
          </div>
        );
      case 3:
        return (
          <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
            ...
            <div><label className="text-xs font-bold text-slate-500 uppercase">Highest Education Degree</label><input type="text" value={data.education.degree} onChange={e => handleEdu('degree', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
            <div><label className="text-xs font-bold text-slate-500 uppercase">Profession / Job Title & Company</label><input type="text" value={data.education.profession} onChange={e => handleEdu('profession', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
            <div><label className="text-xs font-bold text-slate-500 uppercase">Annual Income</label><input type="text" value={data.education.income} onChange={e => handleEdu('income', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
          </div>
        );
      case 4:
        return (
          <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2"><label className="text-xs font-bold text-slate-500 uppercase">Father's Name</label><input type="text" value={data.family.fatherName} onChange={e => handleFamily('fatherName', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2"><label className="text-xs font-bold text-slate-500 uppercase">Father's Occupation</label><input type="text" value={data.family.fatherStatus} onChange={e => handleFamily('fatherStatus', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2"><label className="text-xs font-bold text-slate-500 uppercase">Mother's Name</label><input type="text" value={data.family.motherName} onChange={e => handleFamily('motherName', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2"><label className="text-xs font-bold text-slate-500 uppercase">Mother's Occupation</label><input type="text" value={data.family.motherStatus} onChange={e => handleFamily('motherStatus', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2 md:col-span-1"><label className="text-xs font-bold text-slate-500 uppercase">Brothers</label><input type="text" value={data.family.brothers} onChange={e => handleFamily('brothers', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2 md:col-span-1"><label className="text-xs font-bold text-slate-500 uppercase">Sisters</label><input type="text" value={data.family.sisters} onChange={e => handleFamily('sisters', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
              <div className="col-span-2"><label className="text-xs font-bold text-slate-500 uppercase">Native Place / Hometown</label><input type="text" value={data.family.nativePlace} onChange={e => handleFamily('nativePlace', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
            </div>
          </div>
        );
      case 5:
        return (
          <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
            ...
            <div><label className="text-xs font-bold text-slate-500 uppercase">Contact Number</label><input type="text" value={data.contact.phone} onChange={e => handleContact('phone', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
            <div><label className="text-xs font-bold text-slate-500 uppercase">Email Address (Optional)</label><input type="text" value={data.contact.email} onChange={e => handleContact('email', e.target.value)} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500" /></div>
            <div><label className="text-xs font-bold text-slate-500 uppercase">Residential Address</label><textarea value={data.contact.address} onChange={e => handleContact('address', e.target.value)} rows={3} className="w-full p-3 border rounded-xl font-bold bg-slate-50 mt-1 outline-none focus:border-emerald-500 resize-none" /></div>
          </div>
        );
      case 6:
        return (
          <div className="space-y-6 text-center animate-in zoom-in-95">
            ...
            <p className="text-slate-500 font-medium">Your Islamic Biodata is complete. Download it as a high-quality PDF to share on WhatsApp or Email.</p>
            <button onClick={generatePDF} disabled={isProcessing} className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-black text-xl py-4 rounded-xl shadow-xl transition-transform hover:-translate-y-1 mt-4">
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 min-h-screen">
      <div className="text-center mb-8">
        <h2 className="text-4xl font-black text-slate-800 tracking-tight">Islamic Biodata Maker</h2>
        <p className="text-slate-500 mt-2 text-lg">Create beautiful, professional Muslim marriage biodata profiles in minutes.</p>
      </div>
        ...
        <div className="lg:col-span-5 bg-white rounded-3xl shadow-xl border border-slate-200 p-6 flex flex-col min-h-[650px]">
          <div className="mb-8">
            <div className="flex justify-between items-center mb-2">
              <span className="text-xs font-black text-emerald-600 uppercase tracking-wider">Step {step + 1} of {FLOW_STEPS.length}</span>
              <span className="text-xs font-bold text-slate-400">{FLOW_STEPS[step]}</span>
            </div>
            <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
              <div className="h-full bg-emerald-500 transition-all duration-500" style={{ width: `${((step + 1) / FLOW_STEPS.length) * 100}%` }}></div>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-slate-100 flex justify-between gap-4 mt-auto">
            ...
            <button onClick={() => setStep(Math.min(FLOW_STEPS.length - 1, step + 1))} disabled={step === FLOW_STEPS.length - 1} className={`px-8 py-3 rounded-xl font-bold shadow-md transition-transform ${step === FLOW_STEPS.length - 1 ? 'bg-slate-300 text-slate-500 cursor-not-allowed' : 'bg-emerald-600 hover:bg-emerald-700 text-white hover:-translate-y-1'}`}>Next Step</button>
          </div>
        </div>
